...
// instead of `sdk.NewCompanyEnrichSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CompanyEnrichSDK  { return NewCompanyEnrichSDK(nil) }
func Test() *CompanyEnrichSDK { return TestSDK(nil, nil) }
