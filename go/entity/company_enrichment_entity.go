...
type CompanyEnrichmentEntity struct {
	name    string
...
func NewCompanyEnrichmentEntity(client *core.CompanyEnrichSDK, entopts map[string]any) *CompanyEnrichmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompanyEnrichmentEntity) GetName() string { return e.name }
...
func (e *CompanyEnrichmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompanyEnrichmentEntity) Deleted() bool {
	return e.deleted
}


func (e *CompanyEnrichmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompanyEnrichmentEntity(e.client, opts)
}

func (e *CompanyEnrichmentEntity) Data(args ...any) any {
...
func (e *CompanyEnrichmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CompanyEnrichment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompanyEnrichmentEntity) DataTyped(data ...CompanyEnrichment) CompanyEnrichment {
	if len(data) > 0 {
		return typedFrom[CompanyEnrichment](e.Data(asMap(data[0])))
	}
	return typedFrom[CompanyEnrichment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CompanyEnrichment (all fields
// optional at the wire level).
func (e *CompanyEnrichmentEntity) MatchTyped(match ...CompanyEnrichment) CompanyEnrichment {
	if len(match) > 0 {
		return typedFrom[CompanyEnrichment](e.Match(asMap(match[0])))
	}
	return typedFrom[CompanyEnrichment](e.Match())
}
...
func (e *CompanyEnrichmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompanyEnrichmentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompanyEnrichmentLoadMatch and returns an CompanyEnrichment. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CompanyEnrichmentEntity) LoadTyped(reqmatch CompanyEnrichmentLoadMatch, ctrl map[string]any) (CompanyEnrichment, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CompanyEnrichment{}, err
	}
	return typedFrom[CompanyEnrichment](res), nil
}



func (e *CompanyEnrichmentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CompanyEnrichmentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompanyEnrichmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompanyEnrichmentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompanyEnrichmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
