...
func (sdk *CompanyEnrichSDK) OptionsMap() map[string]any {
...
func (sdk *CompanyEnrichSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CompanyEnrichSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CompanyEnrichSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CompanyEnrichSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CompanyEnrichSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CompanyEnrichSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CompanyEnrichSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CompanyEnrichSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CompanyEnrichSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CompanyEnrichSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CompanyEnrichSDK {
	...
	sdk := NewCompanyEnrichSDK(sdkopts)
	sdk.Mode = "test"
