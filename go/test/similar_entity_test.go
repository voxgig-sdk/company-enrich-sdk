...
func TestSimilarEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set COMPANYENRICH_TEST_SIMILAR_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func similarBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("COMPANYENRICH_TEST_SIMILAR_ENTID")
