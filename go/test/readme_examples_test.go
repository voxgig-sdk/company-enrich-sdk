...
const testSeed = `map[string]any{"entity": map[string]any{"company_enrichment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "similar": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
