// Command CompanyEnrich-mcp is an MCP server exposing the CompanyEnrich
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CompanyEnrich_list  — list records of an entity
//	CompanyEnrich_load  — load a single record of an entity
//
