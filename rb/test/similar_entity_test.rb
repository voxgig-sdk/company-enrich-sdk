...
class SimilarEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set COMPANY_ENRICH_TEST_SIMILAR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def similar_basic_setup(extra)
  ...
  entid_env_raw = ENV["COMPANY_ENRICH_TEST_SIMILAR_ENTID"]
