...
#      offline in seeded test mode (CompanyEnrichSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CompanyEnrich_sdk.rb")
  SDK_CLASS = "CompanyEnrichSDK"
