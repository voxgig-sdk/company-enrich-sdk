...
class SimilarEntity
  ...
  def make
    opts = @_entopts.dup
    SimilarEntity.new(@_client, opts)
  end
  ...
  # @return [Similar, Hash] the current Similar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Similar fields)
  def match_get
  ...
  #
  # @param reqmatch [SimilarListMatch, Hash, nil] match filter (any subset of
  #   Similar fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Similar>, Array] the matching Similar items; raises CompanyEnrichError on failure
