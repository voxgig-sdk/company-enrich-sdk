...
class CompanySearchEntity
  ...
  def make
    opts = @_entopts.dup
    CompanySearchEntity.new(@_client, opts)
  end
  ...
  # @return [CompanySearch, Hash] the current CompanySearch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CompanySearch fields)
  def match_get
  ...
  #
  # @param reqmatch [CompanySearchListMatch, Hash, nil] match filter (any subset of
  #   CompanySearch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CompanySearch>, Array] the matching CompanySearch items; raises CompanyEnrichError on failure
