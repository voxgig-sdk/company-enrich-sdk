...
describe("CompanySearchDirect", function()
  it("should direct-list-company_search", function()
    local setup = company_search_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-company_search", setup.live and "live" or "unit")
...
function company_search_direct_setup(mockres)
