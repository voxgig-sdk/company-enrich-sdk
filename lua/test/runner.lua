...
function runner.env_override(m)
  local live = runner.getenv("COMPANYENRICH_TEST_LIVE")
  local override = runner.getenv("COMPANYENRICH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COMPANYENRICH_TEST_EXPLAIN")
