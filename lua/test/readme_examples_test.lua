...
local SDK_MODULE = "company-enrich_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["company_enrichment"] = { ["test01"] = { id = "test01" } }, ["company_search"] = { ["test01"] = { id = "test01" } }, ["similar"] = { ["test01"] = { id = "test01" } } } }'
