...
describe("SimilarDirect", function()
  it("should direct-list-similar", function()
    local setup = similar_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-similar", setup.live and "live" or "unit")
...
function similar_direct_setup(mockres)
