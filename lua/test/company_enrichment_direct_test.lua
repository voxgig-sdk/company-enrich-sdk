...
describe("CompanyEnrichmentDirect", function()
  it("should direct-load-company_enrichment", function()
    local setup = company_enrichment_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-company_enrichment", setup.live and "live" or "unit")
...
function company_enrichment_direct_setup(mockres)
