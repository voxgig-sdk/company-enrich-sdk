...
function envOverride(m) {
    if ('TRUE' === process.env.COMPANY_ENRICH_TEST_LIVE ||
        'TRUE' === process.env.COMPANY_ENRICH_TEST_OVERRIDE) {
    ...
    m.COMPANY_ENRICH_TEST_EXPLAIN = process.env.COMPANY_ENRICH_TEST_EXPLAIN || m.COMPANY_ENRICH_TEST_EXPLAIN;
    return m;
}
