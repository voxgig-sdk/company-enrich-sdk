...
(0, node_test_1.describe)('SimilarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-similar', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-similar', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COMPANY_ENRICH_TEST_SIMILAR_ENTID'];
...
//# sourceMappingURL=SimilarDirect.test.js.map