...
(0, node_test_1.describe)('CompanyEnrichmentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'company_enrichment.' + op, live))
                return;
        }
        ...
        let company_enrichment_ref01_data = Object.values(setup.data.existing.company_enrichment)[0];
        // LOAD
        const company_enrichment_ref01_ent = client.CompanyEnrichment();
        const company_enrichment_ref01_match_dt0 = {};
        const company_enrichment_ref01_data_dt0 = (await company_enrichment_ref01_ent.load(company_enrichment_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != company_enrichment_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/company_enrichment/CompanyEnrichmentTestData.json');
    ...
    let idmap = transform(['company_enrichment01', 'company_enrichment02', 'company_enrichment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CompanyEnrichmentEntity.test.js.map