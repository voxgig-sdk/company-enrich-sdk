...
(0, node_test_1.describe)('CompanyEnrichmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CompanyEnrichSDK({
    ...
    (0, node_test_1.test)('direct-load-company_enrichment', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-company_enrichment', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CompanyEnrichSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.COMPANY_ENRICH_APIKEY,
        }));
        let idmap = env['COMPANY_ENRICH_TEST_COMPANY_ENRICHMENT_ENTID'];
    ...
    const client = new __1.CompanyEnrichSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CompanyEnrichmentDirect.test.js.map