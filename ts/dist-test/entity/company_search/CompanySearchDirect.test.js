...
(0, node_test_1.describe)('CompanySearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-company_search', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-company_search', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COMPANY_ENRICH_TEST_COMPANY_SEARCH_ENTID'];
...
//# sourceMappingURL=CompanySearchDirect.test.js.map