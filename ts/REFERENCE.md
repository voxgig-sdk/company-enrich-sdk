# CompanyEnrich TypeScript SDK Reference

Complete API reference for the CompanyEnrich TypeScript SDK.
...
```ts
new CompanyEnrichSDK(options?: object)
```
...
#### `CompanyEnrichSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CompanyEnrichSDK` instance in test mode.


### Instance Methods

#### `CompanyEnrichment(data?: object)`

Create a new `CompanyEnrichment` entity instance.
...
**Returns:** `CompanyEnrichmentEntity` instance.

#### `CompanySearch(data?: object)`

Create a new `CompanySearch` entity instance.
...
**Returns:** `CompanySearchEntity` instance.
...
Alias for `CompanyEnrichSDK.test()`.
...
```ts
const result = await client.CompanyEnrichment().load()
```
...
Return the parent `CompanyEnrichSDK` instance.
