...
describe('SimilarDirect', async () => {
  ...
  test('direct-list-similar', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-similar', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['COMPANY_ENRICH_TEST_SIMILAR_ENTID']
