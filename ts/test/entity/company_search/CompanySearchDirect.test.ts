...
describe('CompanySearchDirect', async () => {
  ...
  test('direct-list-company_search', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-company_search', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['COMPANY_ENRICH_TEST_COMPANY_SEARCH_ENTID']
