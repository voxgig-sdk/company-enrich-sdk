...
The PHP SDK for the CompanyEnrich API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->CompanyEnrichment(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->CompanyEnrich(null)->load(
    ["id" => "test01"], null
);
