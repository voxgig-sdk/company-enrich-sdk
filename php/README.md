# CompanyEnrich PHP SDK



The PHP SDK for the CompanyEnrich API — an entity-oriented client using PHP conventions.
...
```
php/
├── companyenrich_sdk.php          -- Main SDK class
...
The main class (`companyenrich_sdk.php`) exports the SDK class
