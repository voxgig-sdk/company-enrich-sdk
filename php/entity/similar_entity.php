...
// CompanyEnrich SDK Similar entity
...
class SimilarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SimilarEntity($this->_client, $opts);
    }

    /**
     * @param Similar|array $args Similar data (assoc-array) to store.
     */
    ...
    /**
     * @return Similar|array The current Similar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Similar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Similar fields).
     */
    ...
    /**
     * List Similar items matching the given filter.
     *
     * @param SimilarListMatch|array|null $reqmatch Match filter (any subset
     *   of Similar fields) as an assoc-array; SimilarListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Similar[]|array A list of Similar items as assoc-arrays at
