...
class SimilarEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COMPANYENRICH_TEST_SIMILAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function similar_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COMPANYENRICH_TEST_SIMILAR_ENTID");
