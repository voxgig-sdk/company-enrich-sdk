...
// CompanyEnrich SDK pipeline test
//
...
{
    private static function utility(): CompanyEnrichUtility
    {
        return new CompanyEnrichUtility();
    }
    ...
    private static function ctx(array $over = []): CompanyEnrichContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CompanyEnrichContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CompanyEnrichOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CompanyEnrichError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CompanyEnrichOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CompanyEnrichMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CompanyEnrichOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CompanyEnrichMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CompanyEnrichOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CompanyEnrichMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CompanyEnrichSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CompanyEnrichMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CompanyEnrichResponse([]),
            'result' => new CompanyEnrichResult([]),
        ]);
        [, $err] = CompanyEnrichMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CompanyEnrichSpec([]),
            'response' => null,
            'result' => new CompanyEnrichResult([]),
        ]);
        [, $err] = CompanyEnrichMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CompanyEnrichSpec(['step' => 's']),
            'response' => new CompanyEnrichResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CompanyEnrichResult([]),
        ]);
        [, $err] = CompanyEnrichMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CompanyEnrichSpec(['step' => 's']),
            'response' => new CompanyEnrichResponse(self::resp(200, ['v' => 1])),
            'result' => new CompanyEnrichResult([]),
        ]);
        [, $err] = CompanyEnrichMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CompanyEnrichSpec(['step' => 's']),
            'response' => new CompanyEnrichResponse(self::resp(200, ['v' => 2])),
            'result' => new CompanyEnrichResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CompanyEnrichMakeResponse::call($ctx);
    ...
    {
        $preset = new CompanyEnrichResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CompanyEnrichSpec([]),
            'response' => new CompanyEnrichResponse([]),
            'result' => new CompanyEnrichResult([]),
        ...
        [$got, $err] = CompanyEnrichMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CompanyEnrichResult([])]);
        [, $err] = CompanyEnrichMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CompanyEnrichSpec([]), 'result' => null]);
        [, $err] = CompanyEnrichMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CompanyEnrichSpec(['step' => 's']),
            'result' => new CompanyEnrichResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CompanyEnrichOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CompanyEnrichMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CompanyEnrichSpec(['step' => 's']),
            'result' => new CompanyEnrichResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CompanyEnrichOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CompanyEnrichMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CompanyEnrichResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CompanyEnrichSpec([]),
            'result' => new CompanyEnrichResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CompanyEnrichMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CompanyEnrichMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CompanyEnrichError('boom', 'boom');
        $utility->fetcher = function (CompanyEnrichContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CompanyEnrichSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CompanyEnrichMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CompanyEnrichContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CompanyEnrichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CompanyEnrichResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CompanyEnrichMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CompanyEnrichContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CompanyEnrichSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CompanyEnrichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CompanyEnrichResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CompanyEnrichSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CompanyEnrichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CompanyEnrichMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CompanyEnrichMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CompanyEnrichResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CompanyEnrichDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CompanyEnrichResult(['ok' => false])]);
        $this->expectException(CompanyEnrichError::class);
        CompanyEnrichDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CompanyEnrichResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CompanyEnrichMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CompanyEnrichMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CompanyEnrichBaseFeature();
        $b = new CompanyEnrichBaseFeature();
        CompanyEnrichFeatureAdd::call($ctx, $a);
        CompanyEnrichFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CompanyEnrichBaseFeature
    {
        $f = new CompanyEnrichBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CompanyEnrichFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CompanyEnrichContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CompanyEnrichSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CompanyEnrichPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CompanyEnrichPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CompanyEnrichResponse(['headers' => null]),
            'result' => new CompanyEnrichResult([]),
        ]);
        CompanyEnrichResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CompanyEnrichResultBody::call($ctx);
