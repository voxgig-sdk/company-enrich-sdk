...
// CompanyEnrich SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CompanyEnrichSDK::test)
...
{
    private const SDK_CLASS = 'CompanyEnrichSDK';
    ...
    private const SDK_BASE = 'companyenrich_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../companyenrich_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
