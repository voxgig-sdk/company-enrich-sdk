...
class SimilarDirectTest extends TestCase
{
    public function test_direct_list_similar(): void
    {
        $setup = similar_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-similar", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
