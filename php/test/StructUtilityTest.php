...
// CompanyEnrich SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CompanyEnrichOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CompanyEnrichOmni::structfix($now, Struct::undef()))
                        !== json_encode(CompanyEnrichOmni::structfix($val, Struct::undef()))) {
