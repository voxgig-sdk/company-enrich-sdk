...
// CompanyEnrich SDK metrics feature
...
class CompanyEnrichMetricsFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _record(CompanyEnrichContext $ctx, bool $ok): void
    {
