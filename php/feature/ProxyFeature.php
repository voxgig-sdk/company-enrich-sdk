...
// CompanyEnrich SDK proxy feature
...
class CompanyEnrichProxyFeature extends CompanyEnrichBaseFeature
{
    ...
    public function init(CompanyEnrichContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CompanyEnrichContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
