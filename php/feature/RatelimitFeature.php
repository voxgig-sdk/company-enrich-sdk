...
// CompanyEnrich SDK ratelimit feature
...
class CompanyEnrichRatelimitFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _acquire(CompanyEnrichContext $ctx): void
    {
    ...
    private function _track(CompanyEnrichContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
