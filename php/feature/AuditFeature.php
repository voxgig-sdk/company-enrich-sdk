...
// CompanyEnrich SDK audit feature
...
class CompanyEnrichAuditFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _emit(CompanyEnrichContext $ctx, string $outcome): void
    {
