...
// CompanyEnrich SDK idempotency feature
...
class CompanyEnrichIdempotencyFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _mutating(CompanyEnrichContext $ctx): bool
    {
