...
class CompanyEnrichTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CompanyEnrichTestRunner.getenv("COMPANYENRICH_TEST_LIVE")
        override = CompanyEnrichTestRunner.getenv("COMPANYENRICH_TEST_OVERRIDE")
        ...
        explain = CompanyEnrichTestRunner.getenv("COMPANYENRICH_TEST_EXPLAIN")
