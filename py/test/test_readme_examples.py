# CompanyEnrich SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CompanyEnrichSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CompanyEnrichSDK(...) and CompanyEnrichSDK.test(...) become
#      CompanyEnrichSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "companyenrich_sdk"
_SDK_CLASS = "CompanyEnrichSDK"
