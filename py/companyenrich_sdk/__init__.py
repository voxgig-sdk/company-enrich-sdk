...
from companyenrich_sdk.utility import register

# Load features
from companyenrich_sdk.feature.base_feature import CompanyEnrichBaseFeature
from companyenrich_sdk.features import _has_feature, _make_feature
...
class CompanyEnrichSDK:
    ...
    def get_utility(self):
        return CompanyEnrichUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CompanyEnrichSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CompanyEnrichment(self, data=None) -> "CompanyEnrichmentEntity":
        ...
        from companyenrich_sdk.entity.company_enrichment_entity import CompanyEnrichmentEntity
    ...
    def CompanySearch(self, data=None) -> "CompanySearchEntity":
        ...
        from companyenrich_sdk.entity.company_search_entity import CompanySearchEntity
    ...
    def Similar(self, data=None) -> "SimilarEntity":
        ...
        from companyenrich_sdk.entity.similar_entity import SimilarEntity
