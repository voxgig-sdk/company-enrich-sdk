...
class CompanySearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanySearchEntity(self._client, opts)
    ...
    def data_get(self) -> CompanySearch:
    ...
    def match_get(self) -> CompanySearch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CompanySearch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CompanySearch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
