...
from companyenrich_sdk.companyenrich_types import (
    CompanyEnrichment,
...
class CompanyEnrichmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanyEnrichmentEntity(self._client, opts)
    ...
    def data_get(self) -> CompanyEnrichment:
    ...
    def match_get(self) -> CompanyEnrichment:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CompanyEnrichment:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CompanyEnrichment().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
