...
// CompanyEnrich SDK utility: graphql
//
...
class CompanyEnrichGraphql
{
    ...
    // equivalent.
    public static function body(CompanyEnrichContext $ctx): mixed
    {
    ...
    public static function errors(CompanyEnrichContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
