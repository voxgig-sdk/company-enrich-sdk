...
// CompanyEnrich SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CompanyEnrichMakeRequest
{
    public static function call(CompanyEnrichContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CompanyEnrichResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CompanyEnrichResponse($fetched);
        } else {
