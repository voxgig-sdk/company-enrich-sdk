...
// CompanyEnrich SDK utility: fetcher

class CompanyEnrichFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CompanyEnrichSDK/1.0)';
    ...
    public static function call(CompanyEnrichContext $ctx, string $fullurl, array $fetchdef): array
    {
