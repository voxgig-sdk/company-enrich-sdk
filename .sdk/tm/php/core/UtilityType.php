...
// CompanyEnrich SDK utility type

class CompanyEnrichUtility
{
    ...
    public static function copy(CompanyEnrichUtility $src): CompanyEnrichUtility
    {
        $u = new CompanyEnrichUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
