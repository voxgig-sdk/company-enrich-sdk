...
// CompanyEnrich SDK cache feature
...
class CompanyEnrichCacheFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _through(CompanyEnrichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
