...
// CompanyEnrich SDK streaming feature
...
class CompanyEnrichStreamingFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _iterate(CompanyEnrichResult $result): \Generator
    {
    ...
    private function _streamable(CompanyEnrichContext $ctx): bool
    {
