...
// CompanyEnrich SDK timeout feature
...
class CompanyEnrichTimeoutFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _with_timeout(CompanyEnrichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CompanyEnrichContext $_ctx, float $ms): void
    {
        $client = $this->client;
