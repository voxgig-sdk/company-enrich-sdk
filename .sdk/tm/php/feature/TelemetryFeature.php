...
// CompanyEnrich SDK telemetry feature
...
class CompanyEnrichTelemetryFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _close(CompanyEnrichContext $ctx, bool $ok): void
    {
