...
// CompanyEnrich SDK clienttrack feature
...
class CompanyEnrichClienttrackFeature extends CompanyEnrichBaseFeature
{
    ...
    public function PostConstruct(CompanyEnrichContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CompanyEnrich-SDK';
