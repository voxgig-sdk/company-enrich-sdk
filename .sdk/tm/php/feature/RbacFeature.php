...
// CompanyEnrich SDK rbac feature
...
class CompanyEnrichRbacFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _required(CompanyEnrichContext $ctx): ?string
    {
    ...
    private function _reject(CompanyEnrichContext $ctx, string $required): void
    {
    ...
    private function _track(CompanyEnrichContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
