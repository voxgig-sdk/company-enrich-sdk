...
// CompanyEnrich SDK netsim feature
...
class CompanyEnrichNetsimFeature extends CompanyEnrichBaseFeature
{
    ...
    private function _simulate(CompanyEnrichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CompanyEnrichContext $ctx, array $applied): void
    {
        $client = $this->client;
