...
class CompanyEnrichTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CompanyEnrichTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CompanyEnrichTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CompanyEnrichTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
