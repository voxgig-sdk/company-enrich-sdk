...
class CompanyEnrichTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CompanyEnrichTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CompanyEnrichTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CompanyEnrichTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
