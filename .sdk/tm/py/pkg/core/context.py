...
from projectname_sdk.core.control import CompanyEnrichControl
...
class CompanyEnrichContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CompanyEnrichControl()
        ...
        if isinstance(sp, CompanyEnrichSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CompanyEnrichResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CompanyEnrichResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CompanyEnrichError(code, msg, self)
