...
|---|---|---|
| `ts/` | @voxgig-sdk/company-enrich-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/company-enrich-sdk \
      --repository voxgig-sdk/company-enrich-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/company-enrich-sdk` shows it, and
`npm trust revoke @voxgig-sdk/company-enrich-sdk --id=<id>` removes it.
