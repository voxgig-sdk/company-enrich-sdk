// Command CompanyEnrich-cli is a CLI + REPL for the CompanyEnrich SDK,
...
const prompt = "company-enrich"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "company_enrichment company_search similar"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      COMPANY_ENRICH_APIKEY (api key), COMPANY_ENRICH_BASE (base url override)")
