...
func registerSDKWords(r *eng.Registry, client *sdk.CompanyEnrichSDK) {
...
func runOp(client *sdk.CompanyEnrichSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
